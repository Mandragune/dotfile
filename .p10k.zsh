# Generated by Powerlevel10k configuration wizard on 2020-08-01 at 22:15 WITA.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='command :'       #❯
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='command :'       #❮
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='command :'       #V
  ...
  typeset -g POWERLEVEL9K_VI_COMMAND_MODE_STRING=MOVE
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=7
  #typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=3
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=SELECT
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=7
  ...
  #typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=1
  bindkey -v
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m - Linux Mint 19.2'
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=7  #66
  # Format for the current time: 09:51:02. See `man 3 strftime`.
  typeset -g POWERLEVEL9K_TIME_FORMAT='%w - %D{%H:%M}'
