# Generated by Powerlevel10k configuration wizard on 2020-07-22 at 11:40 WITA.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=10
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%w - %D{%H:%M}' ###'%D{%H:%M:%S}'###
