...
###FLATPAK###
alias update='clear && flatpak update'
alias search='clear && flatpak search'
alias run='clear && flatpak run'
alias install='clear && flatpak install'
alias uninstall='clear && flatpak uninstall'
alias fclean='clear && flatpak uninstall --unused'
alias fl='clear && flatpak list --app'
